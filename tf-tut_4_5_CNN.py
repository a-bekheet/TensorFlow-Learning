...
from tensorflow.keras import layers, regularizers  # type: ignore # Add this line
from tensorflow.keras.datasets import cifar10  # type: ignore # dataset for 12 CAPATCHA-esque things
...
def my_model():
    ...
    x = layers.Conv2D(64, 5, padding='same', kernel_regularizer=regularizers.l2(0.01),
                      )(x)
    x = layers.BatchNormalization()(x)
    x = keras.activations.relu(x)
