...
model.add(
    layers.SimpleGRU(256, return_sequences=True, activation='tanh') # its returning output from each timestep for stacking
)
model.add(layers.SimpleGRU(256, activation='tanh'))
